    ...
    <!-- Language Dropdown Menu -->
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right p-0">
          <a href="{{ route('language','en') }}" class="dropdown-item @if(app()->getLocale() == 'en') active @endif">
            <i class="flag-icon flag-icon-us mr-2"></i> {{ __('English') }}
          </a>
          
          <a href="{{ route('language','es') }}" class="dropdown-item @if(app()->getLocale() == 'es') active @endif">
